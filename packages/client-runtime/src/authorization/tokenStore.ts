...
import { RelayManagedEndpoint } from "@bibcode/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@bibcode/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@bibcode/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
