import { EnvironmentId, ThreadId, WS_METHODS } from "@bibcode/contracts";
...
import { EnvironmentRpcRequestObserver, request, subscribe, subscribeInSession } from "./client.ts";
...
describe("environment RPC", () => {
  it.effect("observes unary requests until they complete", () =>
    Effect.gen(function* () {
      ...
      const config = { source: "direct-environment" };
      const client = {
