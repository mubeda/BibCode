...
export const ClientSettingsSchema = Schema.Struct({
  ...
  pullRequestsEnabled: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
...
export const CodexSettings = makeProviderSettingsSchema(
  {
    ...
    shadowHomePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        providerSettingsForm: {
          placeholder: "~/.codex-bibcode/personal",
          clearWhenEmpty: "omit",
        },
      }),
    ),
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let BiBCode spawn the server when needed.",
        providerSettingsForm: {
...
export const TerminalSettings = Schema.Struct({
  webglEnabled: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
});
export type TerminalSettings = typeof TerminalSettings.Type;

export const DefaultAgentSelection = Schema.Union([
  Schema.Struct({
...
export type DefaultAgentSelection = typeof DefaultAgentSelection.Type;

export const DEFAULT_DEFAULT_AGENT_SELECTION = {
  kind: "chat",
  instanceId: ProviderInstanceId.make("codex"),
} as const satisfies DefaultAgentSelection;
...
export const ServerSettings = Schema.Struct({
  ...
  enableChatAgentActivity: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
  ...
  defaultAgent: DefaultAgentSelection.pipe(
    Schema.withDecodingDefault(Effect.succeed(DEFAULT_DEFAULT_AGENT_SELECTION)),
  ),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  defaultAgent: Schema.optionalKey(DefaultAgentSelection),
  terminal: Schema.optionalKey(
    Schema.Struct({
      webglEnabled: Schema.optionalKey(Schema.Boolean),
    }),
  ),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  pullRequestsEnabled: Schema.optionalKey(Schema.Boolean),
