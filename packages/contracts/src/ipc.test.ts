    ...
    const probe = decodeDesktopWslServerProbe({
      ...
      consent: {
        ...
        artifact: {
          ...
          sbomName: "bibcode-server-linux-aarch64.cdx.json",
          sbomSha256: "c".repeat(64),
          sbomSignatureName: "bibcode-server-linux-aarch64.cdx.json.minisig",
          nativeSigning: {
            binary: "none",
            package: "none",
            verified: false,
    ...
    const probe = decodeDesktopSshServerProbe({
      ...
      consent: {
        ...
        artifact: {
          ...
          size: 8192,
          sha256: "c".repeat(64),
          signatureName: "bibcode-server-linux-x86_64.deb.minisig",
          sbomName: "bibcode-server-linux-x86_64-deb.cdx.json",
          sbomSha256: "d".repeat(64),
          sbomSignatureName: "bibcode-server-linux-x86_64-deb.cdx.json.minisig",
          nativeSigning: {
            binary: "none",
            package: "none",
            verified: false,
