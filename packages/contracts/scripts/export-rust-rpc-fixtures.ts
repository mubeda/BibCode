...
if (methods.length !== 119) {
  throw new Error(`Expected 119 active RPC methods, found ${methods.length}.`);
}
...
if (typedFailureFixtures.length !== 270) {
  throw new Error(`Expected 270 typed failure fixtures, found ${typedFailureFixtures.length}.`);
}
