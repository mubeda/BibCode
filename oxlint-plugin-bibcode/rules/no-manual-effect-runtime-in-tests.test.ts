...
const rule = createOxlintRuleHarness("bibcode/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("bibcode/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("bibcode/no-manual-effect-runtime-in-tests");
...
const repoRoot = import.meta.dirname.replace(/[/\\]oxlint-plugin-bibcode[/\\]rules$/u, "");
