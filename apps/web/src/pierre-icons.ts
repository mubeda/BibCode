...
const PIERRE_ICON_SPRITE_ID = "bibcode-pierre-file-icon-sprite";

const BIBCODE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="bibcode-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="bibcode-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="bibcode-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="bibcode-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="bibcode-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="bibcode-file-icon-pnpm" viewBox="0 0 32 32">
...
export const BIBCODE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: BIBCODE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "bibcode-file-icon-package-json",
    "tsconfig.json": "bibcode-file-icon-tsconfig",
    "agents.md": "bibcode-file-icon-agents",
    "claude.md": "bibcode-file-icon-claude",
    "readme.md": "bibcode-file-icon-readme",
    "pnpm-lock.yaml": "bibcode-file-icon-pnpm",
    "pnpm-workspace.yaml": "bibcode-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(BIBCODE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${BIBCODE_FILE_ICON_SPRITE}`;
