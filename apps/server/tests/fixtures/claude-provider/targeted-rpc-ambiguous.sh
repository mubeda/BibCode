...
case "$capture" in __*__) capture="$PWD/.bibcode-claude-targeted-ambiguous-requests.ndjson";; esac
case "$settings_capture" in __*__) settings_capture="$PWD/.bibcode-claude-targeted-ambiguous-settings.json";; esac
case "$token_capture" in __*__) token_capture="$PWD/.bibcode-claude-targeted-ambiguous-token";; esac
case "$session_capture" in __*__) session_capture="$PWD/.bibcode-claude-targeted-ambiguous-session";; esac
case "$ready_capture" in __*__) ready_capture="$PWD/.bibcode-claude-targeted-ambiguous-ready";; esac
has_session=false
for argument in "$@"; do
