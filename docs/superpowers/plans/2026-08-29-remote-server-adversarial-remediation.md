...
- [ ] **Step 3: Implement the confirmation state**
...
- [ ] **Step 1: Write red schema/native/UI tests**
...
- [ ] **Step 3: Implement the additive contract and consent action**
...
- [ ] **Step 1: Add red parity fixtures/tests**
...
- [ ] **Step 3: Normalize mapped addresses and consume the shared fixture**
...
- [ ] **Step 1: Write red repository/service/E2EE tests**
...
- [ ] **Step 3: Implement transactional retry and delivery compensation**
...
- [ ] **Step 3: Implement socket-peer admission**
...
- [ ] **Step 3: Split decrypt from async admission**
...
- [ ] **Step 3: Implement fit-first allocation with aging**
...
- [ ] **Step 1: Write a red failed-upgrade behavior test**
...
- [ ] **Step 3: Move lifecycle ownership into the upgrade and set caps**
...
- [ ] **Step 3: Implement the focused provider**
...
- [ ] **Step 4: Update dependency governance, verify, and commit**
...
- [ ] **Step 1: Write red timeout and WSL tests**
...
- [ ] **Step 3: Implement one absolute command deadline**
...
- [ ] **Step 1: Write red event and dialog tests**
...
- [ ] **Step 3: Implement the boot health owner and dialog**
...
- [ ] **Step 1: Write red lifecycle/timeout tests**
...
- [ ] **Step 3: Split lookup from connected acquisition and add Effect timeout**
...
- [ ] **Step 1: Write red shared-policy and cleanup tests**
...
- [ ] **Step 3: Move policy without compatibility aliases**
...
- [ ] **Step 1: Update architecture and runbooks in the same patch**
...
- [ ] **Step 2: Run focused gate and package validation**
...
- [ ] **Step 3: Run Docker remote-server integration**
...
- [ ] **Step 4: Review repository state and commit documentation/evidence**
